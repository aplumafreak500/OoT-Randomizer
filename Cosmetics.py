...
a_button_colors = {
    ...
    "Majora N64 Blue":         (Color(0x64, 0xC8, 0xFF), Color(0x00, 0x50, 0xC8), Color(0x00, 0x50, 0xFF), Color(0x64, 0x64, 0xFF),
                                Color(0x00, 0x32, 0xFF), Color(0x00, 0x64, 0xFF), Color(0x50, 0x96, 0xFF)),
    "Majora N64 Green":        (Color(0x64, 0xFF, 0x78), Color(0x64, 0xFF, 0x78), Color(0x64, 0xFF, 0x78), Color(0x64, 0xFF, 0x78),
                                Color(0x64, 0xFF, 0x78), Color(0x64, 0xFF, 0x78), Color(0x64, 0xFF, 0x78)),
    "Majora N64 Red":          (Color(0xFF, 0x82, 0x3C), Color(0xFF, 0x82, 0x3C), Color(0xFF, 0x82, 0x3C), Color(0xFF, 0x82, 0x3C),
                                Color(0xFF, 0x82, 0x3C), Color(0xFF, 0x82, 0x3C), Color(0xFF, 0x82, 0x3C)),
    "Majora GameCube Green":   (Color(0x64, 0xFF, 0x78), Color(0x00, 0xC8, 0x50), Color(0x00, 0xFF, 0x50), Color(0x64, 0xFF, 0x64),
                                Color(0x00, 0xFF, 0x32), Color(0x00, 0xFF, 0x64), Color(0x50, 0xFF, 0x96)),
    "Majora GameCube Red":     (Color(0xFF, 0x64, 0x64), Color(0xFF, 0x64, 0x64), Color(0xFF, 0x64, 0x64), Color(0xFF, 0x64, 0x64),
                                Color(0xFF, 0x64, 0x64), Color(0xFF, 0x64, 0x64), Color(0xFF, 0x64, 0x64)),
    ...
    "Majora Yellow":           (Color(0xFF, 0xF0, 0x00), Color(0xFF, 0xF0, 0x00), Color(0xFF, 0xF0, 0x00), Color(0xFF, 0xF0, 0x00),
                                Color(0xFF, 0xFF, 0x00), Color(0xFF, 0x96, 0x00), Color(0xFF, 0xFF, 0x32)),
...
b_button_colors = {
    ...
    "Majora N64 Blue":         Color(0x64, 0xC8, 0xFF),
    "Majora N64 Green":        Color(0x64, 0xFF, 0x78),
    "Majora N64 Red":          Color(0xFF, 0x82, 0x3C),
    "Majora GameCube Green":   Color(0x64, 0xFF, 0x78),
    "Majora GameCube Red":     Color(0xFF, 0x64, 0x64),
    "Yellow":                  Color(0xFF, 0xA0, 0x00),
    "Majora Yellow":           Color(0xFF, 0xF0, 0x00),
...
c_button_colors = {
    ...
    "GameCube Grey":           (Color(0x78, 0x78, 0x78), Color(0x78, 0x78, 0x78), Color(0x78, 0x78, 0x78), Color(0x78, 0x78, 0x78)),
    "Majora N64 Blue":         (Color(0x64, 0xC8, 0xFF), Color(0x00, 0x32, 0xFF), Color(0x00, 0x64, 0xFF), Color(0x50, 0x96, 0xFF)),
    "Majora N64 Green":        (Color(0x64, 0xFF, 0x78), Color(0x64, 0xFF, 0x78), Color(0x64, 0xFF, 0x78), Color(0x64, 0xFF, 0x78)),
    "Majora N64 Red":          (Color(0xFF, 0x82, 0x3C), Color(0xFF, 0x82, 0x3C), Color(0xFF, 0x82, 0x3C), Color(0xFF, 0x82, 0x3C)),
    "Majora GameCube Green":   (Color(0x64, 0xFF, 0x78), Color(0x00, 0xFF, 0x32), Color(0x00, 0xFF, 0x64), Color(0x50, 0xFF, 0x96)),
    "Majora GameCube Red":     (Color(0xFF, 0x64, 0x64), Color(0xFF, 0x64, 0x64), Color(0xFF, 0x64, 0x64), Color(0xFF, 0x64, 0x64)),
    "Yellow":                  (Color(0xFF, 0xA0, 0x00), Color(0xFF, 0xFF, 0x00), Color(0xFF, 0x96, 0x00), Color(0xFF, 0xFF, 0x32)),
    "Majora Yellow":           (Color(0xFF, 0xF0, 0x00), Color(0xFF, 0xFF, 0x00), Color(0xFF, 0x96, 0x00), Color(0xFF, 0xFF, 0x32)),
