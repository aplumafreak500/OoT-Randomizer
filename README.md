...
Instead, you can open an issue on this fork [here](https://github.com/aplumafreak500/OoT-Randomizer/issues) or contact me directly on discord (aplumafreak500#5312) for any help, report or request.
...
Run ```Gui.py``` for a graphical interface or ```OoTRandomizer.py``` for the command line version.
They both require Python 3.6+. This will be fully featured,
